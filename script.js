...
const baseWikiDatabase = [
  {
    ...
    action: "Fais toutes les quetes de depart puis bouge vers Sailor Island quand le gain d'XP ralentit.",
    tip: "Ne gaspille pas tes ressources trop tot. L'objectif est surtout de sortir rapidement du tout debut de jeu.",
    summary: "Zone de depart de Sailor Piece pour apprendre les bases avant la vraie progression.",
  ...
  },
  {
    ...
    category: "ile",
    level: "50-500",
    location: "Ile hub centrale accessible via les portails violets.",
    action: "Va y faire ton leveling early game, rouler des fruits, gerer tes rerolls et tenter Jinwoo ou Alucard.",
    tip: "C'est une ile cle du jeu: garde-la en tete pour les dealers de fruits, l'ascension et plusieurs PNJ utiles.",
  ...
  },
  {
    ...
    category: "ile",
    level: "250+",
    location: "Ile de progression early game a enchainer apres les premieres zones.",
    action: "Reste sur les quetes rapides tant que les ennemis restent dans ta tranche de niveau.",
    tip: "Change d'ile avant que les mobs deviennent trop faciles, sinon ton rendement XP baisse.",
    summary: "Ile de progression du debut de jeu utile pour continuer ton leveling apres Starter et Sailor Island.",
  ...
  },
  {
    ...
    category: "ile",
    level: "750+",
    location: "Ile de progression mid-game ou tu peux aussi debloquer Observation Haki.",
    action: "Monte ton niveau ici puis passe voir le maitre d'Observation Haki si tu as les prerequis.",
    tip: "Observation Haki devient un vrai palier de confort pour les combats et la progression.",
    summary: "Ile de progression connue pour l'Observation Haki et la suite du leveling mid-game.",
  ...
  },
  {
    ...
    category: "ile",
    level: "1500+",
    location: "Ile mid-game importante pour Armament Haki et certaines fonctions d'upgrade.",
    action: "Progresse ici si tu es pret pour un vrai cap de build, puis debloque Armament Haki des que possible.",
    tip: "Armament Haki est un gros bond de puissance pour la suite du contenu.",
    summary: "Ile mid-game importante pour Armament Haki, upgrades et progression plus serieuse.",
  ...
  },
  {
    ...
    action: "Utilise-le si tu veux un tres bon fruit de farm avec une mobilite forte grace au vol.",
    tip: "Sa mobilite et ses zones le rendent tres recherche pour le farm.",
    summary: "Fruit legendaire a 2% de chance avec 5 capacites, tres apprecie pour la mobilite et le farm.",
  ...
  },
  {
    ...
    tip: "Tres bon fruit si tu privilegies l'AOE et les attaques qui touchent large.",
  ...
  },
  {
    ...
    category: "race",
    level: "Tous niveaux",
    location: "Race de depart ou resultat possible via Race Reroll.",
    action: "A reroll rapidement si tu cherches un bonus utile pour ton build.",
    tip: "Human n'apporte pas de bonus. C'est surtout une base de depart.",
  ...
  },
  {
    ...
    level: "Tous niveaux",
    location: "Obtenable via Race Reroll depuis l'inventaire.",
    action: "Tres utile si tu veux sustain et degats reguliers.",
  ...
  },
  {
    ...
    level: "Tous niveaux",
    location: "Obtenable via Race Reroll depuis l'inventaire.",
    action: "Tres interessante si tu joues autour de Jinwoo.",
  ...
  },
  {
    ...
    tip: "Elle est importante pour le Manipulator Questline d'apres la doc.",
  ...
  },
  {
    ...
    level: "Tous niveaux",
    location: "Obtenable via Race Reroll depuis l'inventaire.",
    action: "Tres utile si tu joues autour de Shadow ou de builds sombres.",
    tip: "Elle est requise pour le Shadow Trainer d'apres la doc.",
  ...
  },
  {
    ...
    summary: "Race legendary avec tres gros bonus de damage et de HP.",
  ...
  },
  {
    ...
    level: "Tous niveaux",
    location: "Obtenable via Race Reroll depuis l'inventaire.",
    action: "Tres bon choix si tu veux une race mythique puissante et resistante.",
    tip: "La doc verifiee indique surtout un gros bonus de HP; les guides lui attribuent aussi beaucoup de damage.",
    summary: "Race mythique tres puissante orientee survie et pression offensive.",
  ...
  },
  {
    ...
    level: "Tous niveaux",
    location: "Obtenable via Race Reroll depuis l'inventaire.",
    action: "A garder si tu vises Rimuru Mastery ou une race tres complete.",
    tip: "Associe HP, damage, sword multi, lifesteal et damage reduction.",
    summary: "Race mythique tres complete, requise pour Rimuru Mastery.",
  ...
  },
  {
    ...
    level: "Tous niveaux",
    location: "Obtenable via Race Reroll depuis l'inventaire.",
    action: "Tres bonne race melee si tu joues autour de Babylon Key Crafter.",
  ...
  },
  {
    ...
    level: "Tous niveaux",
    location: "Obtenable via Race Reroll depuis l'inventaire.",
    action: "Tres forte race melee/endgame, surtout pour les builds agressifs.",
    tip: "Bonus verifiees: +80% HP, +75% Damage, +20% Melee Multi, +3% Lifesteal, +10% DR.",
    summary: "Race mythique haut de gamme pour builds melee tres offensifs.",
  ...
  },
  {
    ...
    level: "Tous niveaux",
    location: "Obtenable via Race Reroll depuis l'inventaire.",
    action: "Tres bon choix si tu joues melee et vises Strongest Shinobi Mastery.",
    tip: "Elle est liee a The Strongest Shinobi Mastery d'apres la doc.",
  ...
  },
  {
    ...
    level: "Tous niveaux",
    location: "Obtenable via Race Reroll depuis l'inventaire.",
    action: "Tres interessante pour maximiser la chance tout en gardant de grosses stats.",
  ...
  },
  {
    ...
    category: "system",
    level: "750+",
    location: "A apprendre sur Desert Island aupres du maitre correspondant.",
    action: "Debloque-le des que tu peux pour rendre les combats plus confortables et mieux gerer les patterns.",
    tip: "C'est un excellent palier de progression: il rend beaucoup de combats plus lisibles.",
    summary: "Haki a debloquer sur Desert Island, important pour la progression mid-game.",
  ...
  },
  {
    ...
    category: "system",
    level: "1500+",
    location: "A apprendre sur Snow Island apres avoir atteint le palier de progression correspondant.",
    ...
    summary: "Haki a debloquer sur Snow Island, important pour renforcer ton build en milieu de jeu.",
  ...
  },
  {
    ...
    action: "Essaie-le quand ton build early game est stable et que tu tiens deja bien les quetes de l'ile.",
  ...
  },
  {
    ...
    summary: "Boss open world de Sailor Island tres utile pour rerolls et quelques drops vampires.",
  ...
  },
  {
    ...
    summary: "Boss endgame tres rentable avec plusieurs drops garantis et materiaux rares.",
  ...
  },
  {
    ...
    action: "A invoquer avec 1 Abyss Sigil. Les taux montent selon la difficulte.",
    ...
    summary: "Boss scaling de Lawless Island avec drops Eminence et taux variables selon la difficulte.",
  ...
  },
  {
    ...
    summary: "Objet tres rare obtenu sur Madoka Boss a Valentine Island.",
  ...
  },
  {
    ...
    summary: "Objet tres rare obtenu sur Strongest Shinobi Boss a Ninja Island.",
  ...
  },
  {
    ...
    tip: "Taux de drop documente: environ 8.75% a 13.12% selon la difficulte.",
  ...
  },
  {
    ...
    location: "Se drop sur Atomic Boss a Lawless Island.",
    action: "Invoque Atomic avec 1 Abyss Sigil.",
    tip: "Taux de drop documente: environ 0.7% a 1.15% selon la difficulte.",
  ...
  },
  {
    ...
    action: "Utilise-le pour acceder au Boss Rush sur Sailor Island.",
    tip: "Saber Boss est la meilleure source avec 100% de drop garanti.",
    summary: "Ticket permettant d'acceder au Boss Rush de Sailor Island.",
  ...
  },
  {
    ...
    summary: "Cle permettant d'acceder aux donjons du jeu.",
  ...
  },
  {
    ...
    summary: "Objet tres rare obtenu sur Yamato Boss a Judgement Island.",
  ...
  },
  {
    ...
    summary: "Objet tres rare obtenu sur Ichigo Boss a Boss Island.",
  ...
  },
  {
    ...
    action: "Invoque Gilgamesh avec 1 Divine Grail, 500,000 Cash et 500 Gems.",
    tip: "Taux de drop documente: 0.5%.",
    summary: "Objet tres rare obtenu sur Gilgamesh Boss.",
  ...
  },
  {
    ...
    summary: "Objet tres rare obtenu sur Strongest of Today.",
  ...
  },
  {
    ...
    action: "Invoque avec 1 Malevolent Key.",
    tip: "Taux de drop documente: 0.65%.",
    summary: "Objet tres rare obtenu sur Strongest in History.",
  ...
  },
  {
    ...
    summary: "Objet tres rare obtenu sur Rimuru Boss.",
  ...
  },
  {
    ...
    location: "Se drop sur Atomic Boss a Lawless Island.",
    action: "Invoque Atomic avec 1 Abyss Sigil.",
    tip: "Taux de drop documente: 2.85% a 4.5% selon la difficulte.",
  ...
  },
  {
    ...
    location: "Se drop sur Atomic Boss a Lawless Island.",
    action: "Invoque Atomic avec 1 Abyss Sigil.",
    tip: "Taux de drop documente: 0.75% a 1.3% selon la difficulte. Cosmetique.",
  ...
  },
  {
    ...
    summary: "Objet tres rare obtenu sur Moon Slayer Boss.",
  ...
  },
  {
    ...
    summary: "Objet tres rare obtenu sur Ice Queen Boss.",
  ...
  },
  {
    ...
    action: "Reste en mer avec au moins 500,000 bounty, loin des iles.",
  ...
  // ── ARMES ──
  {
    ...
    category: "arme",
    level: "Debutant",
    location: "Achetable chez les marchands d'armes sur plusieurs iles.",
    action: "Bonne arme de depart pour les builds sword.",
    tip: "A remplacer rapidement par une arme plus puissante.",
    summary: "Arme de depart pour les builds sword, accessible et simple.",
  ...
  // ── MASTERIES ──
  {
    ...
    category: "mastery",
    level: "Endgame",
    location: "Shadow Trainer sur Sailor Island. Necessite race Shadowborn.",
  ...
  },
  {
    ...
    category: "mastery",
    level: "Endgame",
    location: "Yamato Trainer. Necessite la race Swordblessed.",
    action: "Obtiens la race Swordblessed, puis trouve le Yamato Trainer.",
    tip: "Mastery sword tres puissante, necessite Swordblessed.",
  ...
  },
  {
    ...
    category: "mastery",
    level: "Endgame",
    location: "Necessite la race Slime.",
    action: "Obtiens la race Slime via Race Reroll, puis cherche le Trainer.",
    tip: "Mastery liee a la race Slime, tres complete.",
  ...
  },
  {
    ...
    category: "mastery",
    level: "Endgame",
    location: "Shinjuku Island. Necessite 1 Limitless Key pour invoquer le boss.",
  ...
  },
  {
    ...
    category: "mastery",
    level: "Endgame",
    location: "Shinjuku Island. Necessite 1 Malevolent Key pour invoquer le boss.",
    action: "Farm Sukuna pour des Malevolent Keys, puis invoque Strongest in History.",
    tip: "Mastery Sukuna endgame, necessite Malevolent Key.",
  ...
  },
  {
    ...
    category: "mastery",
    level: "Endgame",
    location: "Lie au Manipulator Questline. Necessite race Shinigami.",
    action: "Obtiens la race Shinigami, puis suis le Manipulator Questline.",
    tip: "Mastery Aizen liee a la race Shinigami.",
    summary: "Mastery Aizen endgame necessite la race Shinigami et le Manipulator Questline.",
  ...
  },
  {
    ...
    category: "mastery",
    level: "Endgame",
    location: "Necessite la race Servant.",
  ...
  },
  {
    ...
    category: "mastery",
    level: "Endgame",
    location: "Ninja Island. Necessite race Warlord.",
    action: "Obtiens Warlord puis cherche le Trainer sur Ninja Island.",
    tip: "Mastery shinobi liee a la race Warlord.",
    summary: "Mastery endgame de Ninja Island, necessite la race Warlord.",
  ...
  },
  {
    ...
    category: "mastery",
    level: "Endgame",
    location: "Necessite la race Galevorn.",
  ...
  // ── ZONES ──
  {
    ...
    category: "ile",
    level: "5000+",
    location: "Zone avancee accessible apres plusieurs iles de progression.",
    action: "Farm Yuji, Gojo et Sukuna pour Limitless Key et Malevolent Key.",
    tip: "Zone tres importante pour les routes endgame Gojo et Sukuna.",
  ...
  },
  {
    ...
    category: "ile",
    level: "Endgame",
    location: "Zone endgame accessible apres une longue progression.",
    action: "Farm Strongest Shinobi pour des drops garantis et des materiaux endgame.",
    tip: "Boss tres rentable avec rerolls garantis a 100%.",
    summary: "Ile endgame avec le boss Strongest Shinobi, tres rentable pour les rerolls.",
  ...
  },
  {
    ...
    summary: "Ile endgame avec le boss Yamato, utile pour les builds sword.",
  ...
  },
  {
    ...
    summary: "Ile de summon ou on invoque des boss puissants avec des ressources.",
  ...
  },
  {
    ...
    summary: "Ile late game avec Madoka Boss, excellente source de rerolls garantis.",
  ...
  },
  {
    ...
    summary: "Ile endgame avec le boss Rimuru, lie a la race Slime.",
  ...
  },
  {
    ...
    summary: "Ile endgame avec Aizen Boss, meilleure source de Haki Color Reroll.",
  ...
  },
  {
    ...
    summary: "Ile endgame pour invoquer Strongest of Today et Strongest in History.",
...
const mobGuideData = [
  {
    ...
    note: "Mobs de depart, drops tres basiques pour commencer."
  },
  {
  ...
  },
  {
    ...
    zone: "Ninja Island",
    level: "Endgame",
    loot: "Cash, EXP, Race Reroll, Trait Reroll, Battle Sigil (tres rare).",
  ...
  },
  {
    ...
    zone: "Hueco Mundo",
    level: "Endgame",
    loot: "Cash, EXP, Reiatsu Core (rare), Mirage Pendant (tres rare).",
  ...
  },
  {
    ...
    note: "Necessite d'etre loin des iles. Source de Clan Reroll."
  },
  {
    name: "Slime Mobs (Slime Island)",
    zone: "Slime Island",
    level: "Endgame",
    loot: "Cash, EXP, Slime Remnant (rare), Sage Pulse (tres rare).",
  ...
  },
  {
    ...
    zone: "Academy Island",
    level: "Endgame",
    loot: "Cash, EXP, Demonic Fragment (rare), Demonic Shard (tres rare).",
...
const weaponOnlyData = [
  {
    name: "Katana",
    type: "Sword",
    source: "Marchands d'armes sur plusieurs iles",
    drop: "Achat",
    stats: "Stats de base faibles.",
    note: "Arme de depart pour les builds sword. A remplacer rapidement."
  },
  {
    name: "Abyss Edge",
    type: "Sword",
  ...
  },
  {
    ...
    note: "Necessite 1 Boss Key, 100,000 Cash et 175 Gems pour invoquer Saber."
  },
  {
    name: "Sacred Bow",
    type: "Bow",
  ...
  },
  {
    ...
    note: "Necessite 1 Frost Relic, 750,000 Money et 750 Gems."
  },
  {
    name: "Frozen Will",
    type: "Sword",
  ...
  },
  {
    ...
    note: "Necessite 1 Limitless Key pour invoquer le boss."
  },
  {
    name: "Vessel Ring",
    type: "Accessoire",
    ...
    note: "Necessite 1 Malevolent Key pour invoquer le boss."
  }
];
...
const matGuideData = [
  ...
  },
  {
    ...
    note: "Les drops d'Atomic varient selon la difficulte."
  },
  {
    name: "Divine Grail",
    type: "Cle craft",
    ...
    note: "Necessite des materiaux de craft specifiques."
  },
  {
    name: "Dark Grail",
    type: "Cle craft",
  ...
  },
  {
    ...
    note: "Necessite 750,000 Money et 750 Gems en plus."
  },
  {
    name: "Upper Seal",
    type: "Cle craft",
    ...
    note: "Necessite 700,000 Money et 700 Gems en plus."
  },
  {
    name: "Boss Ticket",
    type: "Consommable",
    ...
    drop: "100% sur Saber",
    usedFor: "Acceder au Boss Rush sur Sailor Island.",
  ...
  },
  {
    ...
    note: "Tres rare, important pour la progression Aizen."
  },
  {
    name: "Infinity Core",
    type: "Materiau de route",
  ...
  },
  {
    ...
    note: "Necessaire pour la route Yamato."
  },
  {
    name: "Reversal Pulse",
    type: "Materiau de route",
    ...
    note: "Necessite 1 Limitless Key pour acceder au boss."
  },
  {
    name: "Awakened Cursed Finger",
    type: "Materiau de route",
    ...
    note: "Necessite 1 Malevolent Key pour acceder au boss."
  },
  {
    name: "Bloodline Stone",
    ...
    note: "Necessite 500,000 bounty et rester loin des iles."
  },
  {
    name: "Shadow Heart",
    type: "Materiau de route",
...
const npcGuideData = [
  // ── QUEST NPCs ──
  { name: "Quest NPC 1", role: "Donneur de quete", location: "Starter Island - Sous l'arbre pres du spawn", service: "Quete Thief Hunter. Niveaux 0-99.", note: "Quete: Tue des Thieves. Recompense: Gold + EXP.", questId: "q1" },
  { name: "Quest NPC 2", role: "Donneur de quete", location: "Starter Island - Pres du rivage", service: "Quete Thief Boss. Niveaux 100-249.", note: "Quete: Tue le Thief Boss. Recompense: Gold + EXP.", questId: "q2" },
  { name: "Quest NPC 3", role: "Donneur de quete", location: "Jungle Island - Pres du pont en bois", service: "Quete Monkey Hunter. Niveaux 250-499.", note: "Quete: Tue des singes. Recompense: Gold + EXP.", questId: "q3" },
  { name: "Quest NPC 4", role: "Donneur de quete", location: "Jungle Island - Sur une falaise derriere les tentes rouges", service: "Quete Monkey Boss. Niveaux 500-749.", note: "Quete: Tue le Monkey Boss. Recompense: Gold + EXP.", questId: "q4" },
  { name: "Quest NPC 5", role: "Donneur de quete", location: "Desert Island - Pres des docks, a droite du portail", service: "Quete Desert Bandit. Niveaux 750-999.", note: "Quete: Tue des bandits du desert. Recompense: Gold + Gems + EXP.", questId: "q5" },
  { name: "Quest NPC 6", role: "Donneur de quete", location: "Desert Island - Pres du squelette de dinosaure", service: "Quete Desert Bandit Boss. Niveaux 1000-1499.", note: "Quete: Tue le Desert Boss. Recompense: Gold + Gems + EXP.", questId: "q6" },
  { name: "Quest NPC 7", role: "Donneur de quete", location: "Snow Island - Bord gauche de l'ile, sous un arbre", service: "Quete Frost Rogue Hunter. Niveaux 1500-1999.", note: "Quete: Tue des Frost Rogues. Recompense: Gold + Gems + EXP.", questId: "q7" },
  { name: "Quest NPC 8", role: "Donneur de quete", location: "Snow Island - Sommet de la derniere montagne", service: "Quete Winter Warden Boss. Niveaux 2000-2999.", note: "Quete: Tue le Winter Warden. Recompense: Gold + Gems + EXP.", questId: "q8" },
  { name: "Quest NPC 9", role: "Donneur de quete", location: "Shibuya Station - Tout droit puis premier virage a droite", service: "Quete Sorcerer Hunter. Niveaux 3000-3999.", note: "Quete: Tue des Sorcerers. Recompense: Gold + Gems + EXP.", questId: "q9" },
  { name: "Quest NPC 10", role: "Donneur de quete", location: "Shibuya Station - Rue suivante apres le Gryphon NPC", service: "Quete Panda Boss. Niveaux 4000-5000.", note: "Quete: Tue le Panda Sorcerer Boss. Recompense: Gold + Gems + EXP.", questId: "q10" },
  { name: "Quest NPC 11", role: "Donneur de quete", location: "Hollow Island - Pres du rivage", service: "Quete Hollow Hunter. Niveaux 5000-6250.", note: "Quete: Tue des Hollows. Recompense: Gold + Gems + EXP.", questId: "q11" },
  { name: "Quest NPC 12", role: "Donneur de quete", location: "Shinjuku Island - A droite du spawn", service: "Quete Strong Sorcerer Hunter. Niveaux 6250-7000.", note: "Quete: Tue des Strong Sorcerers. Recompense: Gold + Gems + EXP.", questId: "q12" },
  { name: "Quest NPC 13", role: "Donneur de quete", location: "Shinjuku Island - A gauche du spawn", service: "Quete Curse Hunter. Niveaux 7000-8000.", note: "Quete: Tue des Curse enemies. Recompense: Gold + Gems + EXP.", questId: "q13" },
  { name: "Quest NPC 14", role: "Donneur de quete", location: "Slime Island - A gauche du spawn", service: "Quete Slime Warrior. Niveaux 8000-9000.", note: "Quete: Tue des Slime Warriors. Recompense: Gold + Gems + EXP.", questId: "q14" },
  { name: "Quest NPC 15", role: "Donneur de quete", location: "Academy Island - Dans le chateau", service: "Quete Academy Teachers. Niveaux 9000-10000.", note: "Quete: Tue des Academy Teachers. Recompense: Gold + Gems + EXP.", questId: "q15" },
  { name: "Quest NPC 16", role: "Donneur de quete", location: "Judgement Island - Zone droite depuis le spawn", service: "Quete Blade Masters. Niveaux 7000-8000.", note: "Quete: Tue des Blade Masters. Recompense: Gold + Gems + EXP.", questId: "q16" },
  { name: "Quest NPC 17", role: "Donneur de quete", location: "Soul Dominion - Tout droit depuis le spawn", service: "Quete Quincy Hunter. Niveaux 10000-11500.", note: "Quete: Tue des Quincys. Necessite d'avoir debloque Soul Society via la quete Hogyoku.", questId: "q17" },
  { name: "Quest NPC 18", role: "Donneur de quete", location: "Ninja Island - A droite du spawn", service: "Quete Ninja. Niveaux 11500-12000.", note: "Quete: Tue des Ninjas. Recompense: Gold + Gems + EXP.", questId: "q18" },
  { name: "Quest NPC 19", role: "Donneur de quete", location: "Lawless Island - Sous un arbre pres du spawn", service: "Quete Arena Fighter. Niveaux 12000-99999.", note: "Quete endgame finale. Recompense: Gold + Gems + EXP.", questId: "q19" },
  // ── HAKI TRAINERS ──
  { name: "Observation Haki Trainer", role: "Formateur Haki", location: "Desert Island - Balcon d'une hutte", service: "Vend l'Observation Haki contre 250,000 coins et 300 Gems.", note: "Prerequis: Niveau 750+. Tres utile pour la progression mid-game.", questId: null },
  { name: "Armament Haki Trainer", role: "Formateur Haki", location: "Snow Island - Bord de l'ile", service: "Donne des quetes pour debloquer l'Armament Haki.", note: "Prerequis: Niveau 1500+. Gros gain de puissance.", questId: null },
  { name: "Conqueror Haki Trainer", role: "Formateur Haki", location: "Shibuya Station", service: "Donne une serie de quetes pour debloquer le Conqueror Haki.", note: "Haki endgame, conditions de deblocage avancees.", questId: null },
  // ── MELEE TRAINERS ──
  { name: "Limitless Sorcerer Trainer", role: "Formateur melee", location: "Shibuya Station", service: "Debloque le style de combat Limitless Sorcerer.", note: "Style base sur les capacites de Gojo.", questId: null },
  { name: "Cursed King Trainer", role: "Formateur melee", location: "Shibuya Station", service: "Debloque le style de combat Cursed King.", note: "Style base sur les capacites de Sukuna.", questId: null },
  { name: "Cursed Vessel Trainer", role: "Formateur melee", location: "Shibuya Station", service: "Debloque le style de combat Cursed Vessel.", note: "Style melee de la route Sukuna.", questId: null },
  { name: "Solo Hunter Trainer", role: "Formateur melee", location: "Sailor Island", service: "Debloque le style de combat Solo Hunter.", note: "Style base sur les capacites de Jinwoo.", questId: null },
  { name: "Alucard Trainer", role: "Formateur melee", location: "Sailor Island", service: "Debloque le style de combat Alucard. Necessite race Vampire.", note: "Important pour les builds Vampire / Alucard.", questId: null },
  { name: "Love Maiden Trainer", role: "Formateur melee", location: "Bord de Sailor Island", service: "Debloque le style Love Maiden (Madoka).", note: "Style base sur Madoka.", questId: null },
  { name: "Qin Shi Trainer", role: "Formateur melee", location: "Boss Island", service: "Debloque le style Qin Shi.", note: "Necessite d'avoir invoque Qin Shi Boss.", questId: null },
  { name: "King of Heroes Trainer", role: "Formateur melee", location: "Boss Island", service: "Debloque le style King of Heroes (Gilgamesh).", note: "Style endgame de Boss Island.", questId: null },
  { name: "Blessed Maiden Trainer", role: "Formateur melee", location: "Boss Island", service: "Debloque le style Blessed Maiden. Necessite race Galevorn.", note: "Style melee endgame.", questId: null },
  { name: "Corrupted Knight Trainer", role: "Formateur melee", location: "Boss Island", service: "Debloque le style Corrupted Excalibur.", note: "Necessite d'avoir invoque Corrupted Knight Boss.", questId: null },
  { name: "Demon King Trainer", role: "Formateur melee", location: "Academy Island", service: "Debloque le style Demon King (Anos).", note: "Style endgame lie a la route Anos.", questId: null },
  { name: "Strongest of Today Trainer", role: "Formateur melee", location: "Shinjuku Island", service: "Debloque un style special lie a Gojo endgame.", note: "Necessite d'avoir complete la route Gojo.", questId: null },
  { name: "Strongest in History Trainer", role: "Formateur melee", location: "Shinjuku Island", service: "Debloque un style special lie a Sukuna endgame.", note: "Necessite d'avoir complete la route Sukuna.", questId: null },
  { name: "Strongest Shinobi Trainer", role: "Formateur melee", location: "Ninja Island", service: "Debloque le style Shinobi endgame.", note: "Style endgame de Ninja Island.", questId: null },
  // ── MASTERY NPCs ──
  { name: "Dragon Slayer Master", role: "Mastery NPC", location: "Snow Island - Coin de l'ile", service: "Debloque le F move du Ragna Sword / Dragon Slayer.", note: "Necessite le Dragon Slayer Sword.", questId: null },
  { name: "Manipulator Master", role: "Mastery NPC", location: "Hollow Island - Coin de l'ile", service: "Debloque le F move du Manipulator Sword.", note: "Necessite race Shinigami et le Manipulator Sword.", questId: null },
  { name: "Shadow Master", role: "Mastery NPC", location: "Dungeon Island", service: "Debloque le F move du Shadow Sword. Necessite race Shadowborn.", note: "Necessite Shadow Sword et race Shadowborn.", questId: null },
  { name: "Shadow Monarch Master", role: "Mastery NPC", location: "Dungeon Island", service: "Debloque le F move du Shadow Monarch Sword.", note: "Mastery endgame de la route Shadow.", questId: null },
  { name: "Yamato Master", role: "Mastery NPC", location: "Judgement Island", service: "Debloque le F move du Yamato Sword. Necessite race Swordblessed.", note: "Necessite Yamato Sword et race Swordblessed.", questId: null },
  { name: "True Manipulator Master", role: "Mastery NPC", location: "Soul Dominion", service: "Debloque le F move du True Manipulator Sword.", note: "Necessite d'avoir complete la quete Hogyoku pour acceder a Soul Dominion.", questId: null },
  // ── WEAPON SELLERS ──
  { name: "Katana Seller", role: "Vendeur d'armes", location: "Starter Island", service: "Vend le Katana de base.", note: "Arme de depart, a remplacer rapidement.", questId: null },
  { name: "Dark Blade Seller", role: "Vendeur d'armes", location: "Snow Island", service: "Vend le Dark Blade.", note: "Arme mid-game disponible sur Snow Island.", questId: null },
  { name: "Dragon Slayer Seller", role: "Vendeur d'armes", location: "Snow Island", service: "Vend le Dragon Slayer Sword (Ragna).", note: "Arme mid-game, a combiner avec le Dragon Slayer Master.", questId: null },
  { name: "Gryphon Seller", role: "Vendeur d'armes", location: "Shibuya Station", service: "Vend le Gryphon Sword.", note: "Arme avancee de Shibuya Station.", questId: null },
  { name: "Manipulator Seller", role: "Vendeur d'armes", location: "Hollow Island", service: "Vend le Manipulator Sword.", note: "Necessite race Shinigami pour le Mastery.", questId: null },
  { name: "Ichigo Seller", role: "Vendeur d'armes", location: "Hollow Island", service: "Vend le Ichigo Sword.", note: "Arme de la zone Hollow / Bleach.", questId: null },
  { name: "Shadow Seller", role: "Vendeur d'armes", location: "Dungeon Island", service: "Vend le Shadow Sword.", note: "Arme de la route Shadow, necessite race Shadowborn pour le Mastery.", questId: null },
  { name: "Shadow Monarch Seller", role: "Vendeur d'armes", location: "Dungeon Island", service: "Vend le Shadow Monarch Sword.", note: "Arme endgame de la route Shadow.", questId: null },
  { name: "Slime Seller", role: "Vendeur d'armes", location: "Slime Island", service: "Vend le Rimuru Sword.", note: "Arme de la route Rimuru / Slime.", questId: null },
  { name: "Yamato Seller", role: "Vendeur d'armes", location: "Judgement Island", service: "Vend le Yamato Sword.", note: "Necessite race Swordblessed pour le Mastery.", questId: null },
  { name: "True Manipulator Seller", role: "Vendeur d'armes", location: "Soul Dominion", service: "Vend le True Manipulator Sword.", note: "Necessite d'avoir complete la quete Hogyoku.", questId: null },
  { name: "Atomic Seller", role: "Vendeur d'armes", location: "Lawless Island", service: "Vend le Atomic Sword.", note: "Arme endgame de Lawless Island.", questId: null },
  { name: "Ice Queen Sword Seller", role: "Vendeur d'armes", location: "Boss Island", service: "Vend l'arme de Ice Queen.", note: "Ajout recent selon les sources (avril 2026).", questId: null },
  // ── UTILITAIRES ──
  { name: "Coin Fruit Dealer", role: "Marchand de fruits", location: "Sailor Island - Zone batiments a gauche", service: "Vend des fruits contre des pieces. Light Fruit, Quake Fruit, Flame Fruit...", note: "Source principale de fruits sans Gems.", questId: null },
  { name: "Gems Fruit Dealer", role: "Marchand de fruits premium", location: "Sailor Island - Zone batiments a gauche", service: "Vend des fruits contre des Gems. Catalogue superieur.", note: "Utilise tes Gems ici pour les fruits les plus rares.", questId: null },
  { name: "Ascension NPC", role: "Ascension", location: "Sailor Island - Zone batiments a gauche", service: "Effectue l'ascension du personnage pour debloquer de nouvelles capacites.", note: "A faire quand les prerequis de niveau sont remplis.", questId: null },
  { name: "Boss Rush NPC", role: "Acces Boss Rush", location: "Sailor Island - Zone batiments a gauche", service: "Entree dans le Boss Rush contre un Boss Ticket.", note: "Saber Boss est la meilleure source de Boss Tickets.", questId: null },
  { name: "Stat Reroll NPC", role: "Reroll de stats", location: "Sailor Island - Zone batiments a gauche", service: "Permet de reroller ses stats de base.", note: "Utile pour optimiser ton build.", questId: null },
  { name: "Storage NPC", role: "Stockage", location: "Sailor Island - Zone batiments a gauche", service: "Permet de stocker des objets.", note: "Pratique pour garder des items en reserve.", questId: null },
  { name: "Titles NPC", role: "Gestion des titres", location: "Sailor Island - Zone batiments a gauche", service: "Permet d'equiper et de gerer ses titres.", note: "Equipe tes titres obtenus sur les boss.", questId: null },
  { name: "Blessing NPC", role: "Benediction", location: "Shibuya Station - En face du Set Spawn crystal", service: "Offre des benedictions / buffs temporaires.", note: "Va voir ce PNJ des que tu arrives a Shibuya Station.", questId: null },
  { name: "Slime Key Crafter", role: "Artisan de cle", location: "Slime Island - Pres des maisons en bois", service: "Craft des Slime Keys pour invoquer Rimuru Boss.", note: "Necessite des materiaux specifiques pour craft la cle.", questId: null },
  { name: "Artifacts Master", role: "Echangeur d'artefacts", location: "Endgame - Zone avancee", service: "Echange des items contre des artefacts puissants comme Celestial Rupture et Abyssal Crown.", note: "Artefacts endgame tres puissants.", questId: null }
];

const questGuideData = [
  // ── QUETES PRINCIPALES ──
  { name: "Thief Hunter", npc: "Quest NPC 1", location: "Starter Island", level: "0-99", objective: "Tuer des Thieves sur Starter Island.", rewards: "Gold + EXP", condition: "Aucune. Quete de depart.", type: "Principale" },
  ...
  { name: "Desert Bandit Quest", npc: "Quest NPC 5", location: "Desert Island", level: "750-999", objective: "Tuer des Desert Bandits.", rewards: "Gold + Gems + EXP", condition: "Niveau 750+. Premiers Gems en recompense.", type: "Principale" },
  ...
  { name: "Quincy Hunter", npc: "Quest NPC 17", location: "Soul Dominion", level: "10000-11500", objective: "Tuer des Quincys sur Soul Dominion.", rewards: "Gold + Gems + EXP", condition: "Niveau 10000+ ET avoir complete la quete Hogyoku Fragment pour debloque Soul Society.", type: "Principale" },
  ...
  // ── QUETES SPECIALES ──
  { name: "Demonite Core Quest", npc: "Demonite NPC", location: "Academy Island - Cote gauche de l'ile depuis le portail", level: "Endgame", objective: "Collecter 2 Demonite Fragments et les remettre au PNJ.", rewards: "Calamity Seal + deblocage des drops Calamity sur les ennemis.", condition: "Acceder a Academy Island. Les Demonite Fragments se droppent sur les mobs de la zone.", type: "Speciale" },
  { name: "Hogyoku Fragment Quest", npc: "Gin NPC", location: "Hollow Island - Fin de l'ile", level: "8500+", objective: "Collecter 6 Hogyoku Fragments caches sur differentes iles.", rewards: "Deblocage de Soul Society Island + portail Hogyoku permanent dans le menu teleport.", condition: "Niveau 8500+. Parler au Gin NPC sur Hollow Island. Les 6 fragments sont dissemines sur differentes iles.", type: "Speciale" },
  ...
  { name: "Aizen Quest", npc: "Aizen NPC", location: "Hollow Island - Cote oppose au Hogyoku NPC", level: "5500+", objective: "Remettre le Worthiness Fragment au PNJ Aizen.", rewards: "Aizen Specialization + Aizen Sword (True Sword endgame).", condition: "Avoir complete la Worthiness Fragment Quest. Niveau 5500+.", type: "Speciale" }
];
...
const titleGuideData = [
  ...
  { name: "Golden King Title", boss: "Gilgamesh Boss", location: "Boss Island", drop: "1%", pity: "Non confirme", note: "Titre de Gilgamesh, necessite Divine Grail." },
  { name: "Corrupt Tyrant Title", boss: "Corrupted Knight Boss", location: "Boss Island", drop: "1%", pity: "Non confirme", note: "Titre de Corrupted Knight, necessite Dark Grail." },
  { name: "Strongest Sorcerer Title", boss: "Strongest of Today", location: "Shinjuku Island", drop: "1%", pity: "Non confirme", note: "Titre Gojo endgame, necessite Limitless Key." },
  { name: "Disgraced One Title", boss: "Strongest in History", location: "Shinjuku Island", drop: "1%", pity: "Non confirme", note: "Titre Sukuna endgame, necessite Malevolent Key." },
  ...
  { name: "Demon King Title", boss: "Anos Boss", location: "Academy Island", drop: "1%", pity: "Non confirme", note: "Titre de la route Anos, necessite Calamity Seal." },
  { name: "Eminence Incarnate Title", boss: "Atomic Boss", location: "Lawless Island", drop: "0.7%-1.35%", pity: "Non confirme", note: "Taux variable selon la difficulte." },
  ...
  { name: "Dragon Queen Title", boss: "Sea Serpent / Kraken", location: "Open Sea", drop: "Non confirme", pity: "150", note: "Necessite 500,000 bounty minimum en mer." },
...
const weaponGuideData = [
  ...
  },
  {
    ...
    drop: "1.21%",
    stats: "Arme sword endgame liee a Frostbane.",
    note: "Necessite 1 Frost Relic, 750,000 Money et 750 Gems pour invoquer Ice Queen."
  },
  {
    name: "Frozen Will",
    type: "Sword",
  ...
  },
  {
    ...
    note: "Necessaire pour crafter des objets lies a Yamato Mastery."
  },
  {
    name: "Reversal Pulse",
    type: "Materiau",
  ...
  },
  {
    ...
    note: "Tres rare, important pour la progression Manipulator."
  },
  {
    name: "Dark Ring",
    type: "Accessoire",
...
const clanGuideData = [
  ...
  },
  {
    ...
    passive: "Les coups empilent un bonus de damage jusqu'a +20%, reset apres 6 secondes sans toucher."
  },
  {
    name: "Espada",
    rarity: "Legendary",
...
const bossGuideData = [
  ...
  },
  {
    ...
    note: "Tres bon boss pour farm rerolls."
  },
  {
    name: "Yuji",
    type: "Open World",
  ...
  },
  {
    ...
    note: "Tres bon boss late game pour rerolls et Hearts."
  },
  {
    ...
    note: "Boss tres rentable pour rerolls et progression endgame."
  },
  {
  ...
  },
  {
    ...
    note: "Tres bon premier boss summon pour Boss Tickets."
  },
  {
    name: "Qin Shi",
    type: "Boss Island Summon",
  ...
  },
  {
    ...
    note: "Le Divine Grail doit etre craft selon les guides."
  },
  {
  ...
  },
  {
    ...
    note: "Les taux varient selon la difficulte."
  },
  {
    name: "Moon Slayer",
    type: "Boss Island Summon",
  ...
  },
  {
    ...
    access: "Au moins 500,000 bounty et rester environ 200 a 600 studs loin des iles.",
...
function renderWikiCards() {
  ...
  wikiGrid.innerHTML = wikiDatabase
    .map((entry) => {
      ...
      if (isExplorer) {
        return `
          <article class="wiki-card wiki-card-clickable" data-category="${entry.category}" data-search="${searchTerms}" data-name="${entry.name}" role="button" tabindex="0" title="Voir la fiche : ${entry.name}">
...
function formatLootLinks(lootString) {
  return lootString.replace(/([A-Z][A-Za-z\s']+?)(\s*\([\d.]+%[^)]*\))/g, (match, itemName, chance) => {
    ...
    return `<span class="loot-link loot-link-search" data-query="${trimmed}" title="Chercher : ${trimmed}" role="button" tabindex="0">${trimmed}</span>${chance}`;
  });
}
...
function renderNpcGuide() {
  ...
  const roles = [...new Set(npcGuideData.map(n => n.role.split(" ").slice(0, 2).join(" ")))];
  const groups = {
    "Donneur de": npcGuideData.filter(n => n.role === "Donneur de quete"),
    "Formateur Haki": npcGuideData.filter(n => n.role === "Formateur Haki"),
    "Formateur melee": npcGuideData.filter(n => n.role === "Formateur melee"),
    "Mastery NPC": npcGuideData.filter(n => n.role === "Mastery NPC"),
    "Vendeur d'armes": npcGuideData.filter(n => n.role === "Vendeur d'armes"),
    "Utilitaires": npcGuideData.filter(n => !["Donneur de quete","Formateur Haki","Formateur melee","Mastery NPC","Vendeur d'armes"].includes(n.role))
  };
    ...
    .map((n) => {
      ...
      <article class="race-guide-card">
        <div class="race-guide-top">
          <h3>${n.name}</h3>
          <div class="race-badges">
            <span class="race-badge">${n.role}</span>
          </div>
        </div>
...
function renderSuggestions(entries) {
  ...
  if (!entries.length) {
    suggestionsList.innerHTML = '<span class="suggestion-chip">Aucun resultat proche</span>';
    return;
  }
...
function renderNoResult(query) {
  ...
  resultTitle.textContent = "Aucun resultat exact";
  resultSummary.textContent = `Je n'ai pas trouve "${query}". Essaie un nom plus simple ou clique sur une suggestion.`;
  resultType.textContent = "-";
  resultLevel.textContent = "-";
  resultLocation.textContent = "Essaie un nom d'ile, de fruit, de boss ou de Haki.";
...
function runAssistantSearch() {
  ...
  if (!query) {
    if (resultTitle) {
      ...
      resultSummary.textContent = "Cherche un fruit, une ile, un boss ou une mecanique comme le Haki. Le site te donnera une fiche simple avec des conseils.";
      resultType.textContent = "-";
      resultLevel.textContent = "-";
